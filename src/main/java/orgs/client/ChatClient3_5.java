...
public class ChatClient3_5 implements AutoCloseable {
    ...
    // ... (rest of ChatClient3 methods like login, sendRequestAndAwaitResponse, sendFileBytes, closeConnection)
    ...
    public static void main(String[] args) {
        try (ChatClient3_5 client = new ChatClient3_5()) {
